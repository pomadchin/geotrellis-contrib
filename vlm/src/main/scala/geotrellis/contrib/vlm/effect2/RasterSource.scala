...
package geotrellis.contrib.vlm.effect2

import geotrellis.contrib.vlm.{ConvertTargetCellType, TargetCellType}
import geotrellis.proj4.CRS
import geotrellis.raster.{CellGrid, CellSize, CellType, GridExtent, MultibandTile, Raster, RasterExtent}
import geotrellis.vector.Extent

trait RasterSource extends CellGrid[Long] {
  def uri: String
  def crs: CRS
  def bandCount: Int
